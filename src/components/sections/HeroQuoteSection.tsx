        ...
        >
          ...
          <div className="relative bg-gradient-to-br from-white via-white/98 to-gray-50/90 dark:from-gray-900 dark:via-gray-900/98 dark:to-gray-800/90 backdrop-blur-xl border border-gray-200/60 dark:border-gray-700/60 rounded-3xl p-8 md:p-12 shadow-2xl shadow-black/10 dark:shadow-black/30 transform-gpu">
            ...
            <blockquote className="text-lg md:text-xl lg:text-2xl text-gray-800 dark:text-gray-200 leading-relaxed font-medium text-center mb-8 max-w-4xl mx-auto relative z-10">
              ...
              <span className="bg-gradient-to-r from-primary via-purple-500 to-pink-500 bg-clip-text text-transparent font-bold"> authentically unique</span>. 
              Our designs don&apos;t just look good – they feel right, work perfectly, and drive real results.&rdquo;
            </blockquote>

            {/* Author Signature */}
            <div className="flex items-center justify-center gap-4 pt-6 border-t border-gray-200/30 dark:border-gray-700/30">
              <div className="w-12 h-12 rounded-xl bg-gradient-to-r from-primary via-purple-500 to-pink-500 flex items-center justify-center shadow-lg">
