    ...
    <section className="py-20 bg-gradient-to-br from-primary/5 to-primary/10">
      <div className="container mx-auto px-4">
        ...
        >
          ...
          >
            <div className="bg-card p-6 rounded-2xl shadow-lg hover:shadow-xl transition-shadow duration-300 border border-border/20">
              <Mail className="w-8 h-8 text-primary mx-auto mb-4" />
              <h3 className="text-lg font-semibold text-white mb-2">Email Us</h3>
              <p className="text-primary/80">hello@wafipix.com</p>
              <p className="text-sm text-primary/60 mt-1">24/7 Support</p>
            </div>
            ...
            <div className="bg-card p-6 rounded-2xl shadow-lg hover:shadow-xl transition-shadow duration-300 border border-border/20">
              ...
              <p className="text-sm text-primary/60 mt-1">Mon-Fri, 9AM-6PM</p>
            </div>
            ...
            <div className="bg-card p-6 rounded-2xl shadow-lg hover:shadow-xl transition-shadow duration-300 border border-border/20">
              ...
              <p className="text-sm text-primary/60 mt-1">By appointment</p>
            </div>
          </motion.div>
