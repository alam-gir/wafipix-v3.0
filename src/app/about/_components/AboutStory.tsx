        ...
        <div>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="bg-card/50 backdrop-blur-sm border border-border/20 rounded-lg p-4 flex items-center gap-3">
              ...
              <div>
                <p className="text-subtitle font-semibold text-white">First Project</p>
                <p className="text-primary/80">Restaurant Brand Identity</p>
              </div>
            </div>
            <div className="bg-card/50 backdrop-blur-sm border border-border/20 rounded-lg p-4 flex items-center gap-3">
              ...
              <div>
                <p className="text-subtitle font-semibold text-white">Team Size</p>
                <p className="text-blue-400/80">3 Designers</p>
              </div>
            </div>
            <div className="bg-card/50 backdrop-blur-sm border border-border/20 rounded-lg p-4 flex items-center gap-3">
              <div className="w-8 h-8 bg-primary/10 rounded-lg flex items-center justify-center">
              ...
              <div>
                <p className="text-subtitle font-semibold text-white">Projects</p>
                <p className="text-primary/80">12 Brand Identities</p>
              </div>
            </div>
            <div className="bg-card/50 backdrop-blur-sm border border-border/20 rounded-lg p-4 flex items-center gap-3">
              ...
              <div>
                <p className="text-subtitle font-semibold text-white">Satisfaction</p>
                <p className="text-purple-400/80">100% Rate</p>
              </div>
            </div>
          </div>
        </div>
      ...
      content: (
        <div>
          ...
          <div className="mb-8 space-y-3">
            <div className="flex gap-3 items-center text-body text-primary/80">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="bg-card/50 backdrop-blur-sm border border-border/20 rounded-lg p-4 flex items-center gap-3">
              ...
              <div>
                <p className="text-subtitle font-semibold text-white">Global Reach</p>
                <p className="text-yellow-400/80">25 Countries</p>
              </div>
            </div>
            <div className="bg-card/50 backdrop-blur-sm border border-border/20 rounded-lg p-4 flex items-center gap-3">
              ...
              <div>
                <p className="text-subtitle font-semibold text-white">Packaging</p>
                <p className="text-red-400/80">50+ Designs</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="bg-card/50 backdrop-blur-sm border border-border/20 rounded-lg p-4 flex items-center gap-3">
              ...
              <div>
                <p className="text-subtitle font-semibold text-white">Awards</p>
                <p className="text-emerald-400/80">25+ Won</p>
              </div>
            </div>
            <div className="bg-card/50 backdrop-blur-sm border border-border/20 rounded-lg p-4 flex items-center gap-3">
              ...
              <div>
                <p className="text-subtitle font-semibold text-white">Services</p>
                <p className="text-indigo-400/80">8+ Categories</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="bg-card/50 backdrop-blur-sm border border-border/20 rounded-lg p-4 flex items-center gap-3">
              ...
              <div>
                <p className="text-subtitle font-semibold text-white">Innovation</p>
                <p className="text-orange-400/80">Future Ready</p>
              </div>
            </div>
            <div className="bg-card/50 backdrop-blur-sm border border-border/20 rounded-lg p-4 flex items-center gap-3">
              ...
              <div>
                <p className="text-subtitle font-semibold text-white">Vision</p>
                <p className="text-pink-400/80">Creative Magic</p>
              </div>
            </div>
          </div>
        </div>
